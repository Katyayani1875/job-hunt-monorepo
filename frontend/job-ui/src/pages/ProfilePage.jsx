              ...
              {userType === "candidate" ? (
                <>
                  ...
                  <Section
                    ...
                    fields={["Company", "Job Title", "Duration"]}
                  />
                  <Section
                    title="Skills"
                  ...
                  <Section
                    title="Preferences"
                    fields={["Preferred Job Type", "Notice Period"]}
                  />
                </>
              ) : (
                <>
                  <Section
                    ...
                    fields={["Company Name", "Industry Type", "Size"]}
                  />
                  <Section
                    title="Contact Information"
                    fields={["Contact Person", "Email", "Phone"]}
                  />
                  <Section
                    title="Company Description"
                    fields={["Mission", "Vision", "Culture"]}
                  />
                  <Section
                    title="Job Postings"
                    fields={["Active Jobs", "Manage Jobs"]}
                  />
                  <Section
                    title="Hiring Preferences"
                    fields={["Preferred Roles", "Experience Levels"]}
                  />
                </>
              )}
            </CardContent>
