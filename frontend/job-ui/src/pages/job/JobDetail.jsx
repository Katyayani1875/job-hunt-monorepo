...
const JobDetail = () => {
  ...
  if (!job) return <div className="text-center py-20 text-gray-500">Loading job...</div>;
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl p-8 space-y-6">
        <div>
          ...
          <p className="text-lg mt-1 text-gray-700 dark:text-gray-300">{job.companyName}</p>
        </div>
